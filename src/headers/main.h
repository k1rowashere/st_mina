...
Stepper steppers[] = { (Stepper::Pins) {
                            STEP_PIN_0, DIR_PIN_0, EN_PIN_0, LOW_LIMIT_SWITCH_PIN_0, HIGH_LIMIT_SWITCH_PIN_0
                        },
                        (Stepper::Pins) {
                            STEP_PIN_1, DIR_PIN_1, EN_PIN_1, LOW_LIMIT_SWITCH_PIN_1, HIGH_LIMIT_SWITCH_PIN_1
                        } };

Filler fillers[] = {
    (Filler::Pins) {
LOAD_SOLENOID_0, UNLOAD_SOLENOID_0, FILL_LIMIT_FULL_0, FILL_LIMIT_EMPTY_0, FILL_PEDAL_PIN
},
(Filler::Pins) {
LOAD_SOLENOID_1, UNLOAD_SOLENOID_1, FILL_LIMIT_FULL_1, FILL_LIMIT_EMPTY_1, FILL_PEDAL_PIN
},
};
...
bool ack_flag = false;            // Flag for acknowledging the error
bool G::pos_unlock = true;   // Flag for locking the position
bool G::clear_error = false; // Flag for clearing error
